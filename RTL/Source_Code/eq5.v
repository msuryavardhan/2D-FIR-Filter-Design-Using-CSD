module eq5(input clk,input signed [7:0] x5,input rst,output  [7:0] y5 );
//internal variables
...
assign y5=z1+z2+z3+z4+z5+z6+z21+z22+z31+z32+z41+z42+z11+z12+z61+z62;
endmodule
